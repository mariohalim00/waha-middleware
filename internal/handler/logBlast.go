...
func CreateLogBlast(w http.ResponseWriter, r *http.Request) {
	...
	res, err := logblast.CreateLogBlast(createLogBlastParams)
	if err != nil {
...
func UpdateLogBlast(w http.ResponseWriter, r *http.Request) {
	...
	res, err := logblast.UpdateLogBlast(updateLogBlastParam)
	if err != nil {
